...
export const LOGO = `
${c.orangeRed}      ___${c.reset}
${c.orangeRed}   ╱╱   ╲╲${c.reset}
${c.orange} ╱╱  ${c.green}◉${c.orange}   ${c.green}◉${c.orange}  ╲╲${c.reset}
${c.orange}╱  ╲╲  ${c.coral}▽${c.orange}  ╱╱  ╲${c.reset}
${c.coral}╲   ╲╲___╱╱   ╱${c.reset}
${c.coral} ╲╲  ${c.blue}┏━━━┓${c.coral}  ╱╱${c.reset}
${c.orangeRed}  ╲╲ ${c.blue}┗━━━┛${c.orangeRed} ╱╱${c.reset}
`;
